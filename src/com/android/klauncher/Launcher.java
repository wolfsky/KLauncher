...
public final class Launcher extends Activity implements View.OnClickListener, OnLongClickListener {
    ...
    public void startActivityForResult(Intent intent, int requestCode) {
    	Log.d(LOG_TAG, "startActivityForResult: "+requestCode);
    ...
    private void openFolder(FolderInfo folderInfo) {
        ...
        if (folderInfo instanceof UserFolderInfo) {
            ...
            openFolder = com.android.klauncher.LiveFolder.fromXml(this, folderInfo);
        } else {
            return;
        }
    ...
    private void pickShortcut(int requestCode, int title) {
    	try
    	{
    		Log.d(LOG_TAG,"pickShortcut title: "+getText(title));
    		Log.d(LOG_TAG,"pickShortcut requestCode: "+requestCode);
        ...
        {
        	Log.d(LOG_TAG,"shortcutNames : "+shortcutNames.get(i));
        }
        ...
        */
        Intent pickIntent = new Intent(Intent.ACTION_PICK_ACTIVITY);
        pickIntent.putExtra(Intent.EXTRA_INTENT, new Intent(Intent.ACTION_CREATE_SHORTCUT));
        pickIntent.putExtra(Intent.EXTRA_TITLE, "test");	        
        		        
        startActivityForResult(pickIntent, requestCode);
    	}
    	catch (Exception e)
    	{
    		Log.d(LOG_TAG,"pickShortcut error: "+e.getMessage());
    		e.printStackTrace();
    	}
    }
